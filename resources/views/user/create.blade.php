        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-10" style="margin: 0 auto;">    
                <div class="card">
                    ...
                    <h3 class="card-title">
                        <div class="ml-1 mt-1" style="font-weight: bold"><span class="fa fa-user-plus"></span> Create user</div> 
                    </h3>
...
@section('js')
    <script type="text/javascript" >
        let route_user_store = '{{ route("user.store") }}';
    </script>
    <script type="text/javascript" src="{{ asset('/js/user/create.js') }}"></script>
@endsection